...
import { Gauge, Target, Clock, Trophy, Keyboard, Users, TrendingUp, ArrowRight, Play } from 'lucide-react';
import { Layout } from '@/components/layout';
import { Card, Button, Badge, Progress } from '@/components/ui';
import { useAuth } from '@/contexts/AuthContext';
import { mockDashboardStats, mockAchievements, formatTime, formatRelativeTime } from '@/lib/utils';
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <Card variant="bordered" padding="md">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-2xl font-bold text-white">{stats.avgWpm}</p>
